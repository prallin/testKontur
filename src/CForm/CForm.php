...
class CFormElement implements ArrayAccess {
    ...
    public function __construct($name, $attributes = array()) {
        ...
        $this['name'] = $name;
        if (is_callable('CKontur::Instance()')) {
            $this->characterEncoding = CKontur::Instance()->config['character_encoding'];
        } else {
...
/**
 * Class to easy creating Form Element - text
 * @package KonturCore
 */
...
/**
 * Class to easy creating Form Element - password
 * @package KonturCore
 */
...
/**
 * Class to easy creating Form Element - submit
 * @package KonturCore
 */
...
/**
 * CForm Class to easy creating and handling of forms
 * @package KonturCore
 */

...
class CCTheme extends CObject implements IController {
    ...
    /**
     * construktor for theme controller
     */
    ...
    /**
     * Index for CCTheme controller
     * checks test tpl for them
     */
    public function Index() {
        ...
        $this->views->SetTitle('Theme')
                ->AddInclude(__DIR__ . '/index.tpl.php', array(
                    ...
                    'parent_theme_name' => $this->config['theme']['parent_name'],
                    'methods' => $items,
                ));
    }
